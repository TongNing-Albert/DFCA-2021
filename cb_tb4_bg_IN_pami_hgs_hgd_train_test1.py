...
from casia_new.basic_modules.modules_cb_pami_tab4_IN import *
...
parser.add_argument('--data_root',
                    ...
                    default='/mnt/2TB/acadamic/GaitRecognition/GaitNet-CVPR2019-master/dataset/CASIA-B-/SEG',
...
parser.add_argument('--signature', default='PAMI-CASIA-bg-IN_test1')
